...
/* ===== Static Data ===== */
const weeklyData = {
  4:  { size: 'Poppy Seed', emoji: <span className="emoji">🌱</span>, length: '0.1 cm', weight: '<1 g',   tip: 'Start taking prenatal vitamins with folic acid daily.' },
  5:  { size: 'Sesame Seed', emoji: <span className="emoji">🫘</span>, length: '0.2 cm', weight: '<1 g',   tip: 'Nausea may begin — keep crackers handy for mornings.' },
  6:  { size: 'Sweet Pea', emoji: <span className="emoji">🌸</span>, length: '0.6 cm', weight: '<1 g',   tip: 'Your baby\'s heart is starting to beat this week!' },
  7:  { size: 'Blueberry', emoji: <span className="emoji">🫐</span>, length: '1.3 cm', weight: '<1 g',   tip: 'Stay hydrated — aim for 8-10 glasses of water a day.' },
  8:  { size: 'Raspberry', emoji: <span className="emoji">🍇</span>, length: '1.6 cm', weight: '1 g',    tip: 'Fingers and toes are forming. Eat iron-rich foods.' },
  9:  { size: 'Cherry', emoji: <span className="emoji">🍒</span>, length: '2.3 cm', weight: '2 g',    tip: 'Rest when you can — fatigue is very normal right now.' },
  10: { size: 'Strawberry', emoji: <span className="emoji">🍓</span>, length: '3.1 cm', weight: '4 g',    tip: 'Baby can now move, though you won\'t feel it yet.' },
  11: { size: 'Fig', emoji: <span className="emoji">🫒</span>, length: '4.1 cm', weight: '7 g',    tip: 'Include calcium-rich foods like yogurt and cheese.' },
  12: { size: 'Lime', emoji: <span className="emoji">🍈</span>, length: '5.4 cm', weight: '14 g',   tip: 'You\'re almost through the first trimester! Energy may return soon.' },
  13: { size: 'Peach', emoji: <span className="emoji">🍑</span>, length: '7.4 cm', weight: '23 g',   tip: 'Vocal cords are forming. Talk or sing to your baby!' },
  14: { size: 'Lemon', emoji: <span className="emoji">🍋</span>, length: '8.7 cm', weight: '43 g',   tip: 'Second trimester begins! Many women feel more energetic.' },
  16: { size: 'Avocado', emoji: <span className="emoji">🥑</span>, length: '11.6 cm', weight: '100 g',  tip: 'Baby can hear sounds. Play some gentle music.' },
  18: { size: 'Bell Pepper', emoji: <span className="emoji">🫑</span>, length: '14.2 cm', weight: '190 g',  tip: 'You might start feeling baby kicks — called quickening.' },
  20: { size: 'Banana', emoji: <span className="emoji">🍌</span>, length: '16.4 cm', weight: '300 g',  tip: 'Halfway there! Schedule your anatomy scan if not done.' },
  22: { size: 'Papaya', emoji: <span className="emoji">🥭</span>, length: '19 cm', weight: '430 g',  tip: 'Stretch marks may appear. Keep skin moisturized.' },
  24: { size: 'Corn Ear', emoji: <span className="emoji">🌽</span>, length: '21 cm', weight: '600 g',  tip: 'Baby can now respond to your voice and touch.' },
  26: { size: 'Lettuce', emoji: <span className="emoji">🥬</span>, length: '23 cm', weight: '760 g',  tip: 'Eyes are opening. Maintain a balanced diet with omega-3s.' },
  28: { size: 'Eggplant', emoji: <span className="emoji">🍆</span>, length: '25 cm', weight: '1 kg',   tip: 'Third trimester! Baby is practicing breathing motions.' },
  30: { size: 'Cabbage', emoji: <span className="emoji">🥗</span>, length: '27 cm', weight: '1.3 kg',  tip: 'Braxton Hicks contractions may start. Stay hydrated.' },
  32: { size: 'Squash', emoji: <span className="emoji">🎃</span>, length: '29 cm', weight: '1.7 kg',  tip: 'Baby is gaining fat layers. Eat healthy fats like nuts.' },
  34: { size: 'Cantaloupe', emoji: <span className="emoji">🍈</span>, length: '32 cm', weight: '2.1 kg',  tip: 'Lungs are maturing rapidly. Start packing your hospital bag.' },
  36: { size: 'Honeydew', emoji: <span className="emoji">🍉</span>, length: '34 cm', weight: '2.6 kg',  tip: 'Baby is nearly full-term. Practice breathing exercises.' },
  38: { size: 'Pumpkin', emoji: <span className="emoji">🎃</span>, length: '35 cm', weight: '3 kg',   tip: 'Baby could arrive any day! Rest and prepare your space.' },
  40: { size: 'Watermelon', emoji: <span className="emoji">🍉</span>, length: '36 cm', weight: '3.4 kg',  tip: 'Due date! Stay calm and follow your birth plan. You got this! <span className="emoji">🎉</span>' },
}

const nutritionTips = [
  { label: 'Folic Acid', desc: '400-800 mcg daily for neural development', color: 'from-green-400 to-emerald-500', icon: <span className="emoji">🥦</span> },
  { label: 'Iron', desc: '27 mg daily to prevent anemia', color: 'from-red-400 to-rose-500', icon: <span className="emoji">🥩</span> },
  { label: 'Calcium', desc: '1,000 mg daily for bone development', color: 'from-sky-400 to-blue-500', icon: <span className="emoji">🥛</span> },
  { label: 'Omega-3', desc: 'DHA for brain & eye development', color: 'from-amber-400 to-orange-500', icon: <span className="emoji">🐟</span> },
]
